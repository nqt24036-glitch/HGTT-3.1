      ...
      <div className="md:col-span-2">
        ...
        {selectedSkill ? (
            <div className="p-4 rounded-lg border-2 border-purple-700 bg-gray-900/70 space-y-3">
                ...
                {selectedSkill.spiritRoot && (
                    <div className="flex items-center gap-3 text-sm text-cyan-400 bg-cyan-900/50 border border-cyan-700/50 rounded-md p-2">
                        <div className="flex-shrink-0">
                            <SparklesIcon />
                        </div>
                        <p>
                            Gợi ý: Kỹ năng này nhận được hiệu quả tốt nhất từ tu sĩ có Linh Căn hệ <span className="font-bold text-white">{selectedSkill.spiritRoot}</span>.
                        </p>
                    </div>
                )}
