...
const CharacterDetailPopup: React.FC<CharacterDetailPopupProps> = ({ character, onClose }) => {
  // FIX: Changed type guard from 'level' (present in Monster) to 'totalStats' to correctly differentiate Player/Companion from Monster.
  const isPlayerOrCompanion = 'totalStats' in character;
